  ...
  export const getUserDetails = () => async (dispatch,getState) => {
    try {
      ...
      const { data } = await axios.get(
       'https://localhost:50000/b1s/v1/BusinessPartners?$select=CardCode,CardName,CardType',
       {withCredentials: true}
